...
const KNOWN_HANDLERS = new Set([
  ...
  'OPPONENT_ADD_DON', 'OPPONENT_DON_REST_DEFERRED', 'OPPONENT_DON_RETURN_CHOICE', 'POWER_MOD', 'POWER_MOD_BY_LIFE_COST', 'POWER_MOD_PAIR', 'POWER_MOD_PER_DON_RESTED', 'POWER_MOD_PER_SELF_DON', 'POWER_PER_DISCARD', 'POWER_SET', 'PREVENT_REST',
