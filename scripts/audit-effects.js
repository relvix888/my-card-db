...
const KNOWN_HANDLERS = new Set([
  ...
  'OPPONENT_ADD_DON', 'OPPONENT_DON_REST_DEFERRED', 'OPPONENT_DON_RETURN_CHOICE', 'POWER_MOD', 'POWER_MOD_BY_LIFE_COST', 'POWER_MOD_PAIR', 'POWER_MOD_PER_DON_RESTED', 'POWER_MOD_PER_FIELD_COUNT', 'POWER_MOD_PER_SELF_DON', 'POWER_PER_DISCARD', 'POWER_SET', 'PREVENT_REST',
  ...
  'COPY_POWER_FROM_LEADER', // executeAction case for triggered timing; continuous eval via evaluateCharBasePowerOverride for no-timing clauses
  'POWER_PER_DON_RESTED', // continuous eval via evaluateContinuousPower, not executeAction
  'HAND_COUNTER_MOD', // passive eval via getEffectiveCounter, not executeAction
...
const KNOWN_CHOOSE_HANDLERS = new Set([
  ...
  'CHOOSE_DON_ATTACH_TARGET', 'CHOOSE_DON_RETURN', 'CHOOSE_OPP_DON_RETURN', 'CHOOSE_DON_UNREST',
...
const KNOWN_MODAL_CASES = new Set([
  ...
  'CHOOSE_ATTACK_LOCK_TARGET', 'CHOOSE_BLOCK_DISABLE_TARGET', 'CHOOSE_NULL_EFFECT_TARGET',
  'CHOOSE_CONDITIONAL_KO_TARGET', 'CHOOSE_FIELD_FOR_LIFE', 'CHOOSE_KO_OR_DISCARD_HAND', 'CHOOSE_KO_TARGET', 'CHOOSE_LIFE_OPTIONAL', 'CHOOSE_LIFE_TO_HAND_POSITION', 'CHOOSE_POWER_TARGET', 'CHOOSE_PREVENT_REST_TARGET', 'CHOOSE_REFRESH_LOCK_TARGET',
